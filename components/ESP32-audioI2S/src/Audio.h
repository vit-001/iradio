...
#define ANSI_ESC_WHITE   "\033[37m"
        ...
        if (level == 1 && ARDUHAL_LOG_LEVEL >= 1) {
            logStr.append(ANSI_ESC_RED);
        } else if (level == 2 && ARDUHAL_LOG_LEVEL >= 2) {
            logStr.append(ANSI_ESC_YELLOW);
        } else if (level == 3 && ARDUHAL_LOG_LEVEL >= 3) {
            logStr.append(ANSI_ESC_GREEN);
        } else if (level == 4 && ARDUHAL_LOG_LEVEL >= 4) {
            logStr.append(ANSI_ESC_CYAN);
        } // debug
        else if (level == 5 && ARDUHAL_LOG_LEVEL >= 4) {
